...
OpenClaw Light Rust gateway runs stably under a 10 MiB memory limit: ~1.3 MiB idle, 2–3 MiB under normal load, and a peak of ~8 MiB during extreme parallel web scraping. No OOM kills occurred.

---

## 2. Monitoring Methodology

- `docker stats --no-stream` sampled every 10 seconds, 5 minutes per round, 2 rounds total
- `docker logs --since 10s` collected activity logs in sync
- Monitoring window: UTC 14:54 ~ 15:03 (approximately 9 minutes of continuous sampling)
